...
test.describe('E2E Test Suite', () => {
  ...
  test('Create main menu on side panel', async () => {
  ...
  test('Assert the Subscription menu', async () => {
    ...
    await customAssert('Delete Subscription menu', async () => {
    await page.click(pageobject.removebtn);
    });
    // Reload the page
    await page.reload();
  });
